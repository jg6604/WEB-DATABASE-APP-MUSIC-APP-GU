...
## Technology
python/flask, html, SQL, relational database, RDBMS
...
## Description
Building a new social network for music fans for a startup. The main idea is that users should be able to join the network and to review,recommend, and rate music. Users can also "friend" and "follow" other users, which allows them to share reviews and recommendations with others.
## Steps
1. Design ER diagram.
2. Design relational database schema and some queries, write table definition in SQL, all the data about users, reviews, recommendations, amd music should be stored in a relational database.
